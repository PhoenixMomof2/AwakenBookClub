          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              <div className="carousel-caption d-none d-md-block">
                ...
                <p className=" fw-bolder">Some representative placeholder content for the first slide.</p>
              </div>
            </div>
            <div className="carousel-item">
              ...
              <div className="carousel-caption d-none d-md-block">
                ...
                <p className=" fw-bolder">Some representative placeholder content for the second slide.</p>
              </div>
            </div>
            <div className="carousel-item">
              <img src={AwesomePeopleRead} className="d-block w-100" alt="..."/>
              <div className="carousel-caption d-none d-md-block">
                <h5 className="text-danger fw-bolder">Third slide label</h5>
                <p className=" fw-bolder">Some representative placeholder content for the third slide.</p>
              </div>
            </div>
          </div>
